...
export interface ApiInformationInformation extends Schema.SingleType {
  ...
  attributes: {
    ...
    btn: Attribute.DynamicZone<
      ['menu.button', 'menu.link', 'menu.single-link']
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiNavigationNavigation extends Schema.SingleType {
  ...
  attributes: {
    Links: Attribute.DynamicZone<
      ['menu.single-link', 'menu.button', 'menu.dropdown', 'reusable.label']
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiSocialMediaSocialMedia extends Schema.CollectionType {
  ...
  attributes: {
    ...
    typeSocialMedia: Attribute.Enumeration<
      ['facebook', 'instagram', 'git', 'link']
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
